...
#colorbar for green
norm_temp = mcolors.Normalize(vmin=-0.2, vmax=0)
sm_temp   = cm.ScalarMappable(norm=norm_temp, cmap="RdPu")
sm_temp.set_array([])
...
cbar_temp.set_ticks([-0.2, 0])
cbar_temp.ax.tick_params(labelsize=9)
cbar_temp.set_label("Theta 3", labelpad=-11, fontsize=9)


#add a single black‐line legend entry, above those bars
...
legend_ax.legend([baseline_handle],
                 ...
                 frameon=False,
                 fontsize=9)
ax.set_title("Growth Rate Varying Theta 3")
