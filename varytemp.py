...
theta42 = baseline_drift(6.5, 33.5)
theta43 = baseline_drift(6.5, 34.0)
theta44 = baseline_drift(6.5, 34.5)
theta45 = baseline_drift(6.5, 35.0)
theta46 = baseline_drift(6.5, 35.5)
theta47 = baseline_drift(6.5, 36.0)
theta48 = baseline_drift(6.5, 36.5)
theta49 = baseline_drift(6.5, 37.0)
theta410 = baseline_drift(6.5, 37.5)
theta411 = baseline_drift(6.5, 38.0)
theta412 = baseline_drift(6.5, 38.5)
theta413 = baseline_drift(6.5, 39.0)
theta414 = baseline_drift(6.5, 39.5)
...
for name, sol in solutions.items():
    ...
    plt.plot(sol.t, F_vals, color=colormap[name], alpha=opacity[name], linewidth=lw[name], label=name)
